...
<form method="POST" action="../action/update.php" enctype="multipart/form-data">
	<div class="form-group">
		...
		<input type="text" id="name" placeholder="Suzu Adhikari" name="name" value="<?= $student['name'] ?>">
	</div>
	<div class="form-group">
		<label for="email">Email</label>
		<input type="email" id="email" placeholder="suzuadk30@gmail.com" name="email" value="<?= $student['email'] ?>">
	</div>
	<div class="form-group">
